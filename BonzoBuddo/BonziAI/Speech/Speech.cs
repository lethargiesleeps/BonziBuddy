...
public class Speech : ISpeakable
{
    ...
    public virtual string GetPhrase(int index) => PhraseList[index];
    ...
    public virtual Dictionary<string, string> GetPhraseDictionary() => PhraseDictionary;
